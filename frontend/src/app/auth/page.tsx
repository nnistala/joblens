  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      if (tab === "login") {
        ...
        localStorage.setItem("joblens_token", res.access_token);
      } else {
      ...
      <div className="w-full max-w-md">
        <div className="rounded-2xl border border-gray-200 bg-white p-8 shadow-sm">
          ...
          <div className="text-center">
            ...
            <p className="mt-1 text-sm text-gray-500">
              {tab === "login"
                ...
                : "Join JobLens to save jobs and set up alerts."}
            </p>
          </div>
          ...
          <button
            ...
            className="mt-6 flex w-full items-center justify-center gap-3 rounded-lg border border-gray-300 px-4 py-2.5 text-sm font-medium text-gray-700 transition-colors hover:bg-gray-50"
          >
